            ...
            presets.add(new HashMap<>() {
                {
                    ...
                    put(2, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD1);
                        }
                    });
                    put(3, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD2);
                        }
                    });
                    put(4, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD3);
                        }
                    });
                    put(5, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD0);
                        }
                    });
                    // reihe 2
                    put(6, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD4);
                        }
                    });
                    put(7, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD5);
                        }
                    });
                    put(8, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD6);
                        }
                    });
                    put(9, new ArrayList<>() {
                        {
                    ...
                    put(10, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD7);
                        }
                    });
                    put(11, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD8);
                        }
                    });
                    put(12, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUMPAD9);
                        }
                    });
                    put(13, new ArrayList<>() {
                        {
                            add(KeyEvent.VK_NUM_LOCK);
                        }
                    });
                }
            });
            ...
            presets.add(new HashMap<>() {
                {
                    putAll(presets.get(0));
                    // replace(7 , new
                    // ArrayList<>(){{add(KeyEvent.VK_CONTROL);add(KeyEvent.VK_ALT);add(KeyEvent.VK_NUMPAD2);}});
